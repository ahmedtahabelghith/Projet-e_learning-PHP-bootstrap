...
<html lang="en-us">
 ...
 <!------------------------>
   ...
   <div class="container"  style=" width:100%">
	...
	<thead>
    	<tr>
			<th>Matricule</th><th>CIN</th><th>Login</th><th>Mots de passe</th><th>Note examen</th> <th>Date exmen</th>
		</tr>
	</thead>
    <tbody>
    <?php
	include("includes/classes.php");
			 ...
			 $res=candidatureExamenFinal::listResultat($a->getConnexionBase());
	...
	?>
    	<tr   >
            <td class='Questions'><?php echo $lig[$i]['matricule'] ?></td>
			<td class='Questions'><?php echo $lig[$i]['cin']?></td>
			<td class='Questions'><?php echo $lig[$i]['login']?></td>
			<td class='Questions'><?php echo  $lig[$i]['mdp']?></td>
			<td class='Questions'><?php echo  $lig[$i]['noteEnPourcentage']?></td>
			<td class='Questions'><?php echo  $lig[$i]['dateExamen']?></td>
