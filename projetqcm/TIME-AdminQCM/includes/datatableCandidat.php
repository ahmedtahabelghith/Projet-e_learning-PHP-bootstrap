...
<html lang="en-us">
 ...
 <!------------------------>
   ...
   <body  >
	...
	<thead>
    	<tr>
			<th>Matricule</th><th>CIN</th><th>Nom</th><th>Prénom</th><th>Classe</th><th>Mail</th><th>Action</th>
		</tr>        
	</thead>
    <tbody>
    <?php 
	include("includes/classes.php");
			 ...
			 $res=candidat::listCandidat($a->getConnexionBase()); 
	...
	?>
    	<tr id="<?php  echo $lig[$i]['id']; ?>">
			...
			for($j=0;$j<7;$j++)
			{
				if($j==6){ ?>	<td width="25%"><a class="btn btn-info cedit" href="javascript:void(0)" ><i class="fa fa-pencil"></i> Editer</a>
						...
						<?php }
												...
												switch ($j){
													...
													case 4: echo "<td class='classe'>". $lig[$i]['classe']."</td>"; break;
													case 5: echo "<td class='email'>". $lig[$i]['email']."</td>"; break;
													default :echo "<td class='matricule'>". $lig[$i]['matricule']."</td>" ; break;
												}
    ...
    <script>
      $(document).ready(function() {
		  function add(){
			  $.post('includes/gestionCandidat.php?ng=add/',    {
		  ...
		  function edit(id){
			  $.post('includes/gestionCandidat.php?ng=edit/',    {
						  id:id,
						  matricule: $('#Matricule').val(),
						  cin: $('#CIN').val(),
						  nom: $('#Nom').val(),
        ...
        myTable = $('#example').DataTable({
		  ...
		  $("#addCandidat").click(function(e) {
			  bootbox.dialog({
				  ...
				  message: ' <div class="modal-body"><pre><form name="altEditor-form" role="form"><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="Matricule">Matricule:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="text" id="Matricule" name="Matricule" placeholder="Matricule" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="CIN">CIN:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="text" id="CIN" name="CIN" placeholder="CIN" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="Nom">Nom:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="text" id="Nom" name="Nom" placeholder="Nom" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="Prénom">Prénom:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="text" id="Prénom" name="Prénom" placeholder="Prénom" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="Classe">Classe:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="text" id="Classe" name="Classe" placeholder="Classe" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div><div class="form-group"><div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding-top:7px;"><label for="Email">Email:</label></div><div class="col-sm-9 col-md-9 col-lg-9"><input type="email" id="Email" name="Email" placeholder="Email" style="overflow:hidden" class="form-control  form-control-sm" value=""></div><div style="clear:both;"></div></div></form></pre></div>',
				  buttons: {
					  main: {
						  label: "Valider",
		  ...
		  $(".cdelete").click(function(e){
			  var that=$(this);
			  bootbox.confirm({
				  message: "Voulez vous supprimer ce étudiant ?",
				  size:"small",
				  buttons: {
					  confirm: {
						  label: 'Valider',
				  ...
				  callback: function (result) {
					  ...
					  if(result){
						  ...
						  data={"id":id};
						  url="includes/gestionCandidat.php?ng=delete/";
