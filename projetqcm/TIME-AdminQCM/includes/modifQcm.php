...
$res=question::lectureQuestion($a->getConnexionBase(),$_GET['id']);
$res1=question::lectureChoixQuestion($a->getConnexionBase(),$_GET['id']);
...
<form name="altEditor-form" role="form" style="margin-left: 100px;" action="includes/gestionQuestion.php?ng=edit/" method="post">
