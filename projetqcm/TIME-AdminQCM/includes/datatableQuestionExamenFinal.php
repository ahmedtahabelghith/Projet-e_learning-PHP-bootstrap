 ...
 <!------------------------>
   ...
   <div class="container"  style=" width:100%">
	...
	include("includes/classes.php");
			 ...
			 $res=question::listQuestionReponceExamFinal($a->getConnexionBase());
	...
	?>
    	<tr id="<?php  echo $lig[$i]['reponse']; ?>" style=" <?php if($lig[$i]['Correct']==1){echo 'color:#008000';}else{echo 'color:red';}   ?>" >
			...
			for($j=0;$j<8;$j++)
			{
				if($j==7){ ?>	<td width="25%"><a class="btn btn-info cedit" href="questionExamenFinal.php?page=modifQcmExamenFinal&id=<?php echo $lig[$i]['id']; ?>" ><i class="fa fa-pencil"></i> Editer</a>
    ...
    <script >
      $(document).ready(function() {
		  ...
		  function edit(id){
			  $.post('includes/gestionQuestionExamenFinal.php?ng=edit/',    {
						  id:id,
