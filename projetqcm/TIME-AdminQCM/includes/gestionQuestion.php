...
function add(){
    ...
    { $onof8=1;}
        ...
        $result=question::dernierIdReponse($a->getConnexionBase());

        $res = question::ajoutQuestion($a->getConnexionBase(), $Question, $Note, $Categrie, $Reponse1,$onof1,$Reponse2,$onof2,$Reponse3,$onof3,$Reponse4,$onof4,$Reponse5,$onof5,$Reponse6,$onof6,$Reponse7,$onof7,$Reponse8,$onof8,$result+1);

   header('Location:../question.php?page=ajoutQcm');
...
function delete(){
  ...
  $res=question::deleteReponse($a->getConnexionBase(),$reponse);
        if($res==1){
            echo 1;
        }
        else {
...
function edit(){
   ...
   $res=question::editReponse($a->getConnexionBase(),$idQuestion, $idRep1 , $reponse1 , $correct1 ,  $idRep2  ,$reponse2  ,$correct2 , $idRep3,$reponse3,$correct3,$idRep4,$reponse4 ,$correct4,$idRep5 ,$reponse5  ,$correct5,$idRep6 ,$reponse6  ,$correct6,$idRep7 ,$reponse7,$correct7,$idRep8 ,$reponse8  ,$correct8);
