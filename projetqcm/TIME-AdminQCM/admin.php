...
font-size: 16px;">  Dernier accès : <?php echo date("d-m-Y H:i:s");   ?> &nbsp; <a  href="includes/deconnexion.php" class="btn btn-danger square-btn-adjust">Déconnexion</a> </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 style="display:inline-block; position:relative;"><b>Les admins enregistrés</b></h4>
                            
                            <a id="addAdmin" href="javascript:void(0);" style="float:right; display:inline-block;position:relative;margin-top:15px;" class="btn btn-primary btn-xs "><i class="fa fa-plus"></i> Ajouter Admin</a>
       ...
       <?php
	   include("includes/datatableAdmin.php");
	   ?>
